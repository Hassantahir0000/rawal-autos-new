...
const BillTemplate5 = forwardRef<HTMLDivElement, Props>(({ invoice }, ref) => {
  const pct = invoice.bill5_value ?? 0
  ...
  return (
    <div ref={ref}>
      ...
      <div style={{ width: '75%', margin: '0 auto', fontFamily: "'Poppins', sans-serif", fontSize: '13px', color: '#231F20' }}>
        ...
        {/* Header banner */}
        <img src="/banners/bill5-header.png" alt="Car Masters" style={{ width: '100%', display: 'block', marginBottom: '12px' }} />
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '12px' }}>
          <div>
            <p style={{ marginBottom: '4px' }}>
              ...
              <span style={{ color: '#0044cc' }}>{invoice.b5_id ?? invoice.custom_id}</span>
            </p>
...
BillTemplate5.displayName = 'BillTemplate5'
export default BillTemplate5
